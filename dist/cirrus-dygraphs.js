...
var DygraphCanvasRenderer = (function () {
    ...
    DygraphCanvasRenderer._fillPlotter = function (e) {
        ...
        /* This is problematic - this is where the issue arise with the visibility of the 
         * series.  We want the  series attributes to be accessible without the plot be
         * visible.
         *
         * cirrusio: 25-November-2015
         */
    ...
    legend.generateLegendHTML = function (g, x, sel_points, oneEmWidth, row) {
        ...
        if (typeof (x) === 'undefined') {
            ...
            for (i = 1; i < labels.length; i++) {
                ...
                var id = labels[i].split(' ').join('-') + '-leg';
                var series = g.getPropertiesForSeries(labels[i]);
                /* I removed this so that the series heading is always visible.
                 * cirrusio: 22-November-2015
                 */
                //if (!series.visible) continue;

                /* Added id for grabbing the element outside of here.
                 * cirrusio: 25-November-2015
                 */
